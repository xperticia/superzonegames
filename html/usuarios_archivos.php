...
?>
<p>A continuación, usted podrá consultar, actualizar y eliminar los archivos registrados, y también podrá seguir registrando nuevos archivos a publicarse en <strong><?php echo($sitio_nombre); ?></strong>.</p>
<div class="tabbable">
				...
				<td colspan="3">
					<form method="post" action="<?php echo("usuarios.php?menu=".$_GET['menu']."&uma=".$_GET['uma']); ?>" id="signup">
							...
							<ul class="nav nav-tabs">
								...
								<li><a href="#tab3_<?php echo($registros->fields["ID_INSTITUCION"]); ?>_02" data-toggle="tab">Autoridades</a></li>
								<li><a href="#tab3_<?php echo($registros->fields["ID_INSTITUCION"]); ?>_03" data-toggle="tab">Historia</a></li>
								<li><a href="#tab3_<?php echo($registros->fields["ID_INSTITUCION"]); ?>_04" data-toggle="tab">Objetivos</a></li>
								<li><a href="#tab3_<?php echo($registros->fields["ID_INSTITUCION"]); ?>_05" data-toggle="tab">Otros datos</a></li>
							</ul>
							...
							<div class="tab-content">
								...
								<div id="tab3_<?php echo($registros->fields["ID_INSTITUCION"]); ?>_02" class="tab-pane">
									<div class="control-group">
										<label class="control-label">Autoridades</label>
										<div class="controls">
											<textarea class="ckeditor" id="autoridades_<?php echo($registros->fields["ID_INSTITUCION"]); ?>" name="autoridades_<?php echo($registros->fields["ID_INSTITUCION"]); ?>" rows="17" cols="38" title="Fragmento" style="width: 99%"><?php echo(stripslashes($registros->fields["AUTORIDADES"])); ?></textarea>
										</div>
									</div>
								</div>
								...
								<div id="tab3_<?php echo($registros->fields["ID_INSTITUCION"]); ?>_03" class="tab-pane">
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="ckeditor" id="historia_<?php echo($registros->fields["ID_INSTITUCION"]); ?>" name="historia_<?php echo($registros->fields["ID_INSTITUCION"]); ?>" rows="17" cols="38" title="Fragmento" style="width: 99%"><?php echo(stripslashes($registros->fields["HISTORIA"])); ?></textarea>
										</div>
									</div>
								</div>

								<div id="tab3_<?php echo($registros->fields["ID_INSTITUCION"]); ?>_04" class="tab-pane">
									<div class="control-group">
								...
								<div id="tab3_<?php echo($registros->fields["ID_INSTITUCION"]); ?>_05" class="tab-pane">
			...
			<form method="post" action="<?php echo("usuarios.php?menu=".$_GET['menu']."&uma=".$_GET['uma']); ?>" id="signup">
				<div class="tabbable">
					...
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab202" data-toggle="tab">Autoridades</a></li>
						<li><a href="#tab203" data-toggle="tab">Historia</a></li>
						<li><a href="#tab204" data-toggle="tab">Objetivos</a></li>
						<li><a href="#tab205" data-toggle="tab">Otros datos</a></li>
					</ul>
					...
					<div class="tab-content">
						...
						<div id="tab202" class="tab-pane">
							<div class="control-group">
								<label class="control-label">Autoridades</label>
								<div class="controls">
									<textarea class="ckeditor" id="autoridades" name="autoridades" rows="10" cols="38" title="Fragmento" style="width: 99%"></textarea>
								</div>
							</div>
						</div>
						...
						<div id="tab203" class="tab-pane">
							<div class="control-group">
								<label class="control-label">Historia</label>
								<div class="controls">
									<textarea class="ckeditor" id="historia" name="historia" rows="10" cols="38" title="Fragmento" style="width: 99%"></textarea>
								</div>
							</div>
						</div>

						<div id="tab204" class="tab-pane">
							<div class="control-group">
								<label class="control-label">Objetivos</label>
								<div class="controls">
