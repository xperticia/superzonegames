...
(function($) {
    ...
    function getHead()
    {
        ...
        head += '\t<style type="text/css">html,body { background: #fff; }</style>\n';
        return head += "</head>\n";
    }

    function getBody( printElement )
    {
        return '<body>\n<div class="' + $(printElement).attr("class") + '">' + $(printElement).html() + '\n</div>\n</body>\n';
    }
