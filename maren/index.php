<?php
//	XPANEL 3.0
//	Fecha actualizacion:	09/08/2023 2:00 p.m.
...
if (verificar_url($PlantillaHTML)) {
	...
	$ContenidoHTML = str_replace('images/', XPANEL_SITIO_URL_HOST.'images/', $ContenidoHTML);
	...
	$ContenidoHTML = str_replace("{SITIO_LOGO}", "<img src='" . XPANEL_SITIO_URL_HOST . $sitio_logo_archivo . "' />", $ContenidoHTML);
	...
	$registros = $conexion->Query("SELECT *,SUBSTRING( URL,(INSTR(URL,'=')+1)) as MENU FROM menu_modulos WHERE (categoria = 'Contenidos Web') and (UCASE(nombre_menu) <> 'DIVISOR') ORDER BY orden");
	if ($registros) {
		while (!$registros->EOF) {
			...
			/*
				...
				$registros2 = $conexion->Query("SELECT count(*) as CANTIDAD FROM contenidos WHERE (activo = 1) and (tipo_contenido = '".$tipo_contenido."') and (id_sucursal = '".XPANEL_SUCURSAL."') GROUP BY id_contenido");
				if($registros2) {
				...
				if($registros2) {
					if($registros2->RecordCount() > 0) {
						...
						while(!$registros2->EOF) {
							...
							$registros3 = $temp->Query("SELECT * FROM contenidos WHERE (tipo_contenido = '".$tipo_contenido."') and (activo = 1) and (categoria = '".$registros2->fields["CATEGORIA"]."') and (id_sucursal = '".XPANEL_SUCURSAL."') ORDER BY fecha_alta,id_contenido LIMIT 10");
							if($registros3) {
					...
					if ($registros) {
						if ($registros->RecordCount() > 0) {
							...
							while (!$registros->EOF) {
								...
								$nombre_completo_imagenoriginal = XPANEL_SITIO_URL_HOST.$path_imagenes . "fotogaleria/" . $registros->fields["NOMBRE_ARCHIVO"];
								if (verificar_url($nombre_completo_imagenoriginal)) {
									...
									$nombre_completo_imagensmall = XPANEL_SITIO_URL_HOST.$path_imagenes . "fotogaleria/" . $nombre . "_small." . $extension;
									if (verificar_url($nombre_completo_imagensmall)) {
										$nombre_completo_imagenoriginal = $nombre_completo_imagensmall;
									}
								} else {
									$nombre_completo_imagenoriginal = XPANEL_SITIO_URL_HOST.$path_imagenes . "fotogaleria/foto.gif";
								}
	...
	$url = "";
	if (isset($publicidad_portada_mostrar) && ($publicidad_portada_mostrar == "s") && (verificar_url(XPANEL_SITIO_URL_HOST . $path_imagenes . $publicidad_portada_archivo))) {
		$url = "<img src='" . XPANEL_SITIO_URL_HOST . $path_imagenes . $publicidad_portada_archivo . "' style='width: 100%;padding: 0;' />";
	...
	$url = "";
	if (isset($publicidad_h_mostrar) && ($publicidad_h_mostrar == "s") && (verificar_url(XPANEL_SITIO_URL_HOST . $path_imagenes . $publicidad_h_archivo))) {
		$url = "<img src='" . XPANEL_SITIO_URL_HOST . $path_imagenes . $publicidad_h_archivo . "' style=\"padding: 0;\" />";
	...
	$url = "";
	if (isset($publicidad_v_mostrar) && ($publicidad_v_mostrar == "s") && (verificar_url(XPANEL_SITIO_URL_HOST . $path_imagenes . $publicidad_v_archivo))) {
		$url = "<img src='" . XPANEL_SITIO_URL_HOST . $path_imagenes . $publicidad_v_archivo . "' />";
	...
	if (isset($sitio_url_facebook) and ($sitio_url_facebook != "")) {
		$redes_sociales .= "	<li><a href=\"" . $sitio_url_facebook . "\" target=\"_blank\" alt=\"siguenos en facebook\" title=\"siguenos en facebook\"><img src=\"".XPANEL_SITIO_URL_HOST."images/facebook.png\" width=\"32\" alt=\"facebook\" border=\"0\" /></a></li>\n";
	}
	if (isset($sitio_url_facebook_group) and ($sitio_url_facebook_group != "")) {
		$redes_sociales .= "	<li><a href=\"" . $sitio_url_facebook_group . "\" target=\"_blank\" alt=\"siguenos en facebook\" title=\"siguenos en facebook\"><img src=\"".XPANEL_SITIO_URL_HOST."images/facebook-group.png\" width=\"32\" alt=\"facebook-group\" border=\"0\" /></a></li>\n";
	}
	if (isset($sitio_url_twitter) and ($sitio_url_twitter != "")) {
		$redes_sociales .= "	<li><a href=\"" . $sitio_url_twitter . "\" target=\"_blank\" alt=\"siguenos en twitter\" title=\"siguenos en twitter\"><img src=\"".XPANEL_SITIO_URL_HOST."images/twitter.png\" width=\"32\" alt=\"twitter\" border=\"0\" /></a></li>\n";
	}
	if (isset($sitio_url_linkedin) and ($sitio_url_linkedin != "")) {
		$redes_sociales .= "	<li><a href=\"" . $sitio_url_linkedin . "\" target=\"_blank\" alt=\"siguenos en linkedin\" title=\"siguenos en linkedin\"><img src=\"".XPANEL_SITIO_URL_HOST."images/linkedin.png\" width=\"32\" alt=\"linkedin\" border=\"0\" /></a></li>\n";
	}
	if (isset($sitio_url_google) and ($sitio_url_google != "")) {
		$redes_sociales .= "	<li><a href=\"" . $sitio_url_google . "\" target=\"_blank\" alt=\"siguenos en google+\" title=\"siguenos en google+\"><img src=\"".XPANEL_SITIO_URL_HOST."images/google.png\" width=\"32\" alt=\"google\" border=\"0\" /></a></li>\n";
	}
	if (isset($sitio_url_youtube) and ($sitio_url_youtube != "")) {
		$redes_sociales .= "	<li><a href=\"" . $sitio_url_youtube . "\" target=\"_blank\" alt=\"siguenos en youtube\" title=\"siguenos en youtube\"><img src=\"".XPANEL_SITIO_URL_HOST."images/youtube.png\" width=\"32\" alt=\"youtube\" border=\"0\" /></a></li>\n";
	}
	$redes_sociales .= "</ul>\n";
	...
	if (isset($sitio_url_facebook) and ($sitio_url_facebook != "")) {
		$redes_sociales_header .= "	<li><a href=\"" . $sitio_url_facebook . "\" target=\"_blank\" alt=\"siguenos en facebook\" title=\"siguenos en facebook\"><img src=\"".XPANEL_SITIO_URL_HOST."images/facebook.png\" width=\"16\" alt=\"facebook\" border=\"0\" /></a></li>\n";
		$redes_sociales_footer .= "	<a href=\"" . $sitio_url_facebook . "\" target=\"_blank\" alt=\"siguenos en facebook\" title=\"siguenos en facebook\"><img src=\"".XPANEL_SITIO_URL_HOST."images/facebook.png\" width=\"16\" alt=\"facebook\" border=\"0\" /></a> ";
	}
	if (isset($sitio_url_facebook_group) and ($sitio_url_facebook_group != "")) {
		$redes_sociales_header .= "	<li><a href=\"" . $sitio_url_facebook_group . "\" target=\"_blank\" alt=\"siguenos en facebook\" title=\"siguenos en facebook\"><img src=\"".XPANEL_SITIO_URL_HOST."images/facebook-group.png\" width=\"16\" alt=\"facebook-group\" border=\"0\" /></a></li>\n";
		$redes_sociales_footer .= "<a href=\"" . $sitio_url_facebook_group . "\" target=\"_blank\" alt=\"siguenos en facebook\" title=\"siguenos en facebook\"><img src=\"".XPANEL_SITIO_URL_HOST."images/facebook-group.png\" width=\"16\" alt=\"facebook-group\" border=\"0\" /></a> ";
	}
	if (isset($sitio_url_twitter) and ($sitio_url_twitter != "")) {
		$redes_sociales_header .= "	<li><a href=\"" . $sitio_url_twitter . "\" target=\"_blank\" alt=\"siguenos en twitter\" title=\"siguenos en twitter\"><img src=\"".XPANEL_SITIO_URL_HOST."images/twitter.png\" width=\"16\" alt=\"twitter\" border=\"0\" /></a></li>\n";
		$redes_sociales_footer .= "<a href=\"" . $sitio_url_twitter . "\" target=\"_blank\" alt=\"siguenos en twitter\" title=\"siguenos en twitter\"><img src=\"".XPANEL_SITIO_URL_HOST."images/twitter.png\" width=\"16\" alt=\"twitter\" border=\"0\" /></a> ";
	}
	if (isset($sitio_url_linkedin) and ($sitio_url_linkedin != "")) {
		$redes_sociales_header .= "	<li><a href=\"" . $sitio_url_linkedin . "\" target=\"_blank\" alt=\"siguenos en linkedin\" title=\"siguenos en linkedin\"><img src=\"".XPANEL_SITIO_URL_HOST."images/linkedin.png\" width=\"16\" alt=\"linkedin\" border=\"0\" /></a></li>\n";
		$redes_sociales_footer .= "<a href=\"" . $sitio_url_linkedin . "\" target=\"_blank\" alt=\"siguenos en linkedin\" title=\"siguenos en linkedin\"><img src=\"".XPANEL_SITIO_URL_HOST."images/linkedin.png\" width=\"16\" alt=\"linkedin\" border=\"0\" /></a> ";
	}
	if (isset($sitio_url_google) and ($sitio_url_google != "")) {
		$redes_sociales_header .= "	<li><a href=\"" . $sitio_url_google . "\" target=\"_blank\" alt=\"siguenos en google+\" title=\"siguenos en google+\"><img src=\"".XPANEL_SITIO_URL_HOST."images/google.png\" width=\"16\" alt=\"google\" border=\"0\" /></a></li>\n";
		$redes_sociales_footer .= "<a href=\"" . $sitio_url_google . "\" target=\"_blank\" alt=\"siguenos en google+\" title=\"siguenos en google+\"><img src=\"".XPANEL_SITIO_URL_HOST."images/google.png\" width=\"16\" alt=\"google\" border=\"0\" /></a> ";
	}
	if (isset($sitio_url_youtube) and ($sitio_url_youtube != "")) {
		$redes_sociales_header .= "	<li><a href=\"" . $sitio_url_youtube . "\" target=\"_blank\" alt=\"siguenos en youtube\" title=\"siguenos en youtube\"><img src=\"".XPANEL_SITIO_URL_HOST."images/youtube.png\" width=\"16\" alt=\"youtube\" border=\"0\" /></a></li>\n";
		$redes_sociales_footer .= "<a href=\"" . $sitio_url_youtube . "\" target=\"_blank\" alt=\"siguenos en youtube\" title=\"siguenos en youtube\"><img src=\"".XPANEL_SITIO_URL_HOST."images/youtube.png\" width=\"16\" alt=\"youtube\" border=\"0\" /></a> ";
	}
	...
	if ($registros and $registros->RecordCount() > 0) {
		...
		while (!$registros->EOF) {
			...
			//	verifico si el archivo existe
			$nombre_completo_imagenoriginal = XPANEL_SITIO_URL_HOST.$path_imagenes . "fotogaleria/" . $registros->fields["NOMBRE"];
			if (verificar_url($nombre_completo_imagenoriginal)) {
				$carousel_header .= "		<img src=\"" . XPANEL_SITIO_URL_HOST.$path_imagenes . "fotogaleria/" . $registros->fields["NOMBRE"] . "\" alt=\"\" />\n";
			} else {
				$carousel_header .= "		<img src=\"" . XPANEL_SITIO_URL_HOST.$path_imagenes . "publicidad_portada_1250x250.png" . "\" alt=\"\" />\n";
			}
			if (($registros->fields["DESCRIPCION"] != "") && ($registros->fields["DESCRIPCION"] != null)) {
		...
		$carousel_header .= "			<p>No hay im&aacute;genes de portada registradas para esta sucursal.</p>\n";
		$carousel_header .= "		</div>\n";
		$carousel_header .= "	</div>\n";
		$carousel_header .= "</div>\n";
	}
